...
public class BeforePraticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_before_pratice);
                ...
                db.collection("users")
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(BeforePraticeActivity.this, "Lỗi", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(BeforePraticeActivity.this, MainActivity.class);
