...
public class BeforeEditFlashcardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_before_edit_flashcards);
                ...
                db.collection("users")
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(BeforeEditFlashcardsActivity.this, "Lỗi", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(BeforeEditFlashcardsActivity.this, MainActivity.class);
